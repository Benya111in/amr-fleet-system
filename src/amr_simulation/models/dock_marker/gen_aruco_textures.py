#!/usr/bin/env python3
"""
ArUco 마커 텍스처 생성기 (DICT_4X4_100, id 0~83).
...
10~41 = 기둥 8개 × 네 면, 42~83 = 랙 7열 × 3행 × 양면 위치 표지 (통로가 6 m 주기라 LiDAR 만으로는 구별 못 하는 순간 이동의
...
def main():
    ...
    for mid in range(N_IDS):
        ...
        path = os.path.join(out, f"aruco_4x4_100_{mid}.png")
