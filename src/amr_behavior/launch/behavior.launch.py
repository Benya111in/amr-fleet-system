"""
작업 수행 계층 기동: task_executor_node + docking_server_node (components.md §3.5).
...
인자
    ...
    groot_publisher_port     Groot ZMQ PUB 포트 (기본 1666, 5대면 로봇마다 다르게)
    groot_server_port        Groot ZMQ 서버 포트 (기본 1667)
...
def _launch_setup(context, *args, **kwargs):
    ...
    if waiting is not None:
        executor_overrides['waiting_pose'] = waiting
    docking_overrides = {
        'use_sim_time': use_sim_time,
